...
def ensure_database_schema() -> None:
    ...
    required_tables = {
        ...
        TaxGuide.__tablename__,
        FiscalObligation.__tablename__,
        Ticket.__tablename__,
        TicketMessage.__tablename__,
        Customer.__tablename__,
        EmployeeProfile.__tablename__,
        CustomerAssignment.__tablename__,
        Task.__tablename__,
        TaskTransition.__tablename__,
    }
